...
GO
CREATE TABLE [dbo].[D_Order_Date]
(
    [DateKey]         [int] IDENTITY (1, 1) PRIMARY KEY NOT NULL,
    [OrderDateSql]    [datetime] UNIQUE                 NOT NULL,
    [OrderMothName]   AS (datename(month, [OrderDateSql])) PERSISTED,
...
GO
ALTER TABLE [dbo].[F_Internet_Sales]
    CHECK CONSTRAINT [FK_F_Sales_D_Individual_Customer]
GO
ALTER TABLE [dbo].[F_Internet_Sales]
    WITH CHECK
...
GO
ALTER TABLE [dbo].[F_Internet_Sales]
    CHECK CONSTRAINT [FK_F_Sales_D_Product]
GO